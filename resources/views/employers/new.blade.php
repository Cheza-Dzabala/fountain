       ...
       <div class="portlet light  col-md-8 ">
           <div class="portlet-title">
               <div class="caption font-green">
                   ...
                   <span class="caption-subject bold uppercase"> New Employer Record</span>
               </div>
           </div>
           <div class="portlet-body form">
               <form action="{{ route('employer.save') }}" method="post" class="" role="form">
                   {{ csrf_field() }}
                   <div class="form-body">
                       ...
                       <div class="form-group form-md-line-input form-md-floating-label{{ $errors->has('primaryContactNumber') ? ' has-error' : '' }}">
                           <input type="text" class="form-control" id="primaryContactNumber" name="primaryContactNumber" value="{{ old('primaryContactNumber') }}">
                       ...
                       <div class="form-group form-md-line-input form-md-floating-label{{ $errors->has('secondaryContactNumber') ? ' has-error' : '' }}">
                           <input type="text" class="form-control" id="secondaryContactNumber" name="secondaryContactNumber" value="{{ old('secondaryContactNumber') }}">
                       ...
                       <div class="form-group form-md-line-input form-md-floating-label{{ $errors->has('physicalAddress') ? ' has-error' : '' }}">
                           <textarea class="form-control" name="physicalAddress">{{ old('physicalAddress') }}</textarea>
                       ...
                       <div class="form-group form-md-line-input form-md-floating-label{{ $errors->has('postalAddress') ? ' has-error' : '' }}">
                           <textarea class="form-control" name="postalAddress">{{ old('postalAddress') }}</textarea>
